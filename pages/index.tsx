...
const Home: NextPage<homeProps> = ({ results }) => {
  ...
  return (
    <div className={styles.container + 
      ...
      <main className={styles.main + `flex flex-col  h-[95vh] overflow-hidden`}>

          <div id={`Home-Navbar-wrapper`}
            className="flex relative z-60 top-0 items-center justify-center">
            <Navbar
              parentState={{
                boxerSelected,
                showAddModal,
          ...
          <div id={`Home-content-main`} className="flex relative z-52 items-center justify-center top-[20%] h-[80%] w-full">
          ...
          <div id="Home-content-corner-1">
            { boxerSelected.length >= 1 &&
              <AnimatePresence>
              <motion.div
                  className={`absolute left-0 z-49 bg-blue-800 px-4 py-2 mt-20 rounded-md
          ...
          <div id="Home-Main-wrapper"
            className={`relative top-[30vh] z-48 w-[55vw] h-[65vh] rounded-md
          ...
          <div id="Home-content-corner-2">
            { boxerSelected.length === 2 &&
              <AnimatePresence>
                <motion.div
                    className={`absolute right-0 bg-red-700 px-4 py-2 mt-20 rounded-md
                    ${!hideFightAcceptModal ? `duration-100 w-[20vw] h-[84vh] top-[2vh]` : `duration-100 w-[18vw] h-[70vh] top-[20vh]`}
                    `}
                    initial={{ opacity: 0, x: 20 }}
