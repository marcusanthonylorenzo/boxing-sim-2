    ...
    <div className={`${hideModal} absolute overflow-hidden h-full w-full`}>
        <div id={`FightAcceptModal-main`}
            ...
            <div id={`FightAcceptModal-wrapper`}
                className={`flex flex-col fixed top-[10vh] bg-[#1f2957] h-[80vh] w-[70vw]  max-w-2xl rounded-lg shadow-inner items-center justify-center overflow-hidden`}>
                    
                <div id="FightAcceptModal-taleOfTheTape"
                    className={`flex relative top-0 mb-10`}>
                    <section id="title" className={`flex flex-col bg-white shadow-2xl h-[56vh] w-[45vw] p-6 font-semibold justify-center items-center` }>
                ...
                <div id="FightAcceptModal-contract" className='flex justify-center items-center gap-7 py-3 rounded-sm shadow-md bg-white w-[90%]'>
                    <h2 className={`relative font-semibold text-[#3d2e5a] text-[24px] m-0`}>SIGN CONTRACT</h2>

                    <button id={`FightAcceptModal-accept_fight`}
                        className={`relative top-[5%] w-[100px] h-[35px] bg-[#33a935] text-white rounded-md hover:scale-[105%] hover:duration-150 font-semibold`}
                        onClick={() => handleAcceptFight()}>
                        <h5>FIGHT</h5>
                    </button>

                    <button id={`FightAcceptModal-reject_fight`}
                        className={`relative top-[7%] w-[100px] h-[35px] bg-zinc-500 opacity-50 text-white rounded-md hover:scale-[105%] hover:duration-150`}
        ...
        <div id={`FightAcceptModal-overlay`} className={`absolute bg-zinc-900 opacity-90 top-[0] left-[0]
